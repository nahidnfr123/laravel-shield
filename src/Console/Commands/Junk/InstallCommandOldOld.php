...
namespace NahidFerdous\Shield\Console\Commands\Junk;
...
class InstallCommandOldOld extends BaseShieldCommand
{
    ...
    protected function runComposerRequire(string $package): void
    {
        ...
        $process->setTimeout(null); // optional, no timeout for long installs

        try {
            $process->mustRun(function ($type, $buffer) {
                echo $buffer; // stream output to console
            });
    ...
    protected function setupJWT(): void
    {
        ...
        $this->runRequiredCommand('jwt:secret', ['--force' => true]);
